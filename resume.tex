...
\resumeProject
{Medift} %Project Name
{A platform to connect patients with ambulance made using Figma and Kotlin}
...
{A facebook app clone made using Jetpack compose}
...
\small{\begin{tabular*}{\textwidth}[t]{p{1\textwidth} p{1\textwidth}}

\hspace{-3.1mm}{\textbf{ Programming languages:} C++, C, Kotlin} 
\\
\hspace{-3.1mm}{\textbf{ Developer Tools:} Android Studio, IntelliJ IDEA, Firebase - Realtime Database, Firestore Database, AWS Cloud Management}
\\
\hspace{-3.1mm}{\textbf{ Android Development Skills:} Jetpack Compose,Retrofit, Okhttp3, Coroutines, AsyncTasks, Dagger-Hilt, Navigation Components, Safe-args, Moshi, Gson, MVVM Architecture}
\end{tabular*}}
